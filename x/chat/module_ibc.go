...
func (am AppModule) OnRecvPacket(
	...
	case *types.ChatPacketData_MessagePacketPacket:
		packetAck, err := am.keeper.OnRecvMessagePacketPacket(ctx, modulePacket, *packet.MessagePacketPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeMessagePacketPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_MessagePacketPacket:
		err := am.keeper.OnAcknowledgementMessagePacketPacket(ctx, modulePacket, *packet.MessagePacketPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeMessagePacketPacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_MessagePacketPacket:
		err := am.keeper.OnTimeoutMessagePacketPacket(ctx, modulePacket, *packet.MessagePacketPacket)
		if err != nil {
			return err
		}
